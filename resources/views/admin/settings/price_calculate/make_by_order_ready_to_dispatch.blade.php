                    ...
                    <div class="card-body">
                        ...
                        <div class="form_box">
                            ...
                            <div class="form_box_inr">
                                <div class="box_title">
                                    <h2>Price Calculator (Make By Order Ready To Dispatch)</h2>
                                </div>
                                <div class="form_box_info">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="gold_price_24k_1gm_mbo_rtd" class="form-label">24K Gold Price 1Gm.</label>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <p style="font-size: 14px; text-align:center; margin:0;"><strong>{{ $category->GroupName }}</strong></p>
                                        </div>
                                        <input type="hidden" name="category_name[]" value="{{ $category->GroupName }}">
                                        <input type="hidden" name="category_id[]" value="{{ $category->ItemGroupID }}">
