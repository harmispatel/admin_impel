                                ...
                                <div class="form_box_inr">
                                    ...
                                    <div class="form_box_info">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="tag" class="form-label">Link <span class="text-danger">*</span></label>

                                                <input type="text" name="link" value="{{ $bottom_banner['tag_link'] }}" class="form-control {{ ($errors->has('link')) ? 'is-invalid' : '' }}">
